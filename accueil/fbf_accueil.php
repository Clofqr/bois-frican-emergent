<?php
$title = "Accueil";
// Utilise $basePath défini par index.php ('./'), sinon '../' quand la page
// est appelée directement via /accueil/fbf_accueil.php.
$basePath = $basePath ?? '../';
...
<section id="carousel-menu">
    <div class="carousel-container carousel-accueil">
        <div class="carousel-slide">
            <video class="carousel-video" autoplay loop muted playsinline preload="metadata" poster="' . $basePath . 'images/gallery_accueil2.jpg">
                <source src="' . $basePath . 'images/video1.mp4" type="video/mp4">
            </video>
            <img src="' . $basePath . 'images/gallery_accueil2.jpg" alt="Pâturage">
            <img src="' . $basePath . 'images/poneys_gallery1.jpg" alt="Les poneys">
            <img src="' . $basePath . 'images/vaches_gallery6.jpg" alt="Les vaches">
            <img src="' . $basePath . 'images/atelier_gallery.jpg" alt="Ateliers et séjours">
            <img src="' . $basePath . 'images/gallery_accueil_michka.jpg" alt="Michka">
            <img src="' . $basePath . 'images/vaches_traite.jpg" alt="La traite">
            <img src="' . $basePath . 'images/logement_sejour.jpg" alt="Vacances à la ferme">
            <img src="' . $basePath . 'images/gallery_accueil3.jpg" alt="Logement séjour équestre">
        </div>
